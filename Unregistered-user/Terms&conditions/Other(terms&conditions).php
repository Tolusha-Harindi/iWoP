...
<div class="main-box">
    <div class="top-row">
        <div id="title-img">
            ...
            <center>
                <h1 id="title-head">Terms and Conditions</h1>
            </center>
        </div>
    </div>
    <div class="down-row">
        <div class="col-left-30">
            <img src="images/Logo.jpg" alt="Landing">
        </div>
        <div class="col-right-70">
            <dl>
                <dt><h4>General</h4></dt>
                <dd><p>The service provides guarantee that his or her Content do not violate any copyright, intellectual
...
<div class="footer">
    <div class="inner-footer">
        ...
        <div class="footer-items">
            ...
            <ul>
                <a href="#"><li>How To Add My Services</li></a>
                <a href="#"><li>How To Select Categories</li></a>
                <a href="#"><li>Banner Advertising</li></a>
            </ul>
        </div>
        ...
        <div class="footer-items">
            ...
            <ul>
                ...
                <a href="termsandcondition.html"><li>Terms & Condition</li></a>
