...
<div class="main-box">
    <div class="top-row">
        <div id="title-img">
            <img src="images/back-img-1.jpg" alt="Snow" style="width:100%; height: 200px">
            <center>
                <h1 id="title-head">Privacy Policy</h1>
            </center>
        </div>
    </div>
    <div class="down-row">
        <div class="col-full" style="padding: 20px;">

            <p>At iWoP, accessible from iwop.com, one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is collected and recorded by iWoP and how we
                use it.</p>

            <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to
                contact us.</p>

            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website in
                regard to the information that they shared and/or collect in iWoP. This policy is not applicable to any
            ...
            <ol style="color:#000;list-style-type: circle; list-style-position: inside;">
            ...
            <p>iWoP follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <p>Like any other website, iWoP uses 'cookies'. These cookies are used to store information including
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of iWoP.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on iWoP, which are sent directly to users'
            ...
            <p>Note that iWoP has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>iWoP's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>iWoP does not knowingly collect any Personal Identifiable Information from children under the age of 13.
