      ...
      <div class="split right1">
        <div class="centered">
            ...
            <div class="details">
                ...
                <a href="#" input type="submit" value="button"  class="button2"> Job Invite </a> 
                ...
                <div class="star2">
                    ...
                    <form name = "reg-w" onsubmit="return validation()" method="post">
                        ...
                        <input id="review" type="text" placeholder = "Review" class="input" required>
                    
                    </form>
                    <a href="#" input type="submit" value="submit"  class="button4"> Submit</a>
                </div>
            </div>
        </div>
      </div>
