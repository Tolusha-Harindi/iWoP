        ...
        <div class="col-right-70" style="border: 1px solid black; margin: 2px;">
            <div class="down-row">
                <div class="col-left-30">
                    <img src="images/bag.webp" alt="user" id="side-img">
                </div>
                <div class="col-right-70" style="padding: 0;">
                    <label for="cPassword">Company <i class="red-s">*</i></label>
                    <input type="text" id="cPassword" name="cPassword" required>
                    <label for="nPassword">Title <i class="red-s">*</i></label>
                    <input type="text" id="nPassword" name="nPassword" required>
                    <label for="ccPassword">Job Description <i class="red-s">*</i></label>
                    <input type="text" id="ccPassword" name="ccPassword" required>
                    <label for="ccPassword">Nearest City Or Town <i class="red-s">*</i></label>
                    <input type="text" id="ccPassword" name="ccPassword" required>
                    <label for="ccPassword">Phone Number <i class="red-s">*</i></label>
                    <input type="text" id="ccPassword" name="ccPassword" required>
                    <label for="ccPassword">Starting Date <i class="red-s">*</i></label>
                    <input type="text" id="ccPassword" name="ccPassword" required>
                    <label for="ccPassword">Due Date <i class="red-s">*</i></label>
                    <input type="text" id="ccPassword" name="ccPassword" required>
                    <label for="ccPassword">Budget (Rs.)</label>
                    <input type="text" id="ccPassword" name="ccPassword" required>
