        ...
        public function company_register() {
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $data = [
				    ...
				    //validate owner name on letters/numbers
                     if(empty($data['owner_name'])){
                        $data['ownerError'] = 'Please Enter Company Owner name';
                    }
                    elseif (!preg_match($ownerValidation, $data['owner_name'])){
                        $data['ownerError'] = 'Name can only contain letters and numbers';
                    }
				    ...
				    //validate company address on letters/numbers
                     if(empty($data['address'])){
                        $data['addressError'] = 'Please Enter Company address';
                    }
