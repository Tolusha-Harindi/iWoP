...
//////////////////////////////////////////////////////////////// Company Register  /////////////////////////////////////////////////////////////
         public function company_register($data){
            $this->db->query('INSERT INTO company (reg_no, com_name, owner_name, contact, email, password, address, prof_pic) VALUES (:reg_no, :com_name, :owner_name, :contact, :email, :password, :address, :prof_pic)');
