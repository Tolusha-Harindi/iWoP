...
//////select ads data - upadte ads   //////////////////////////////////////////////////////////////////////////////////////////////////////
     public function findPostbyId($ads_id){
        $this->db->query('SELECT * FROM company_ads WHERE ads_id = :ads_id');
...
//////upadte ads   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     public function updatePost($data){
        $this->db->query('UPDATE company_ads SET title = :title, category = :category, description= :description, address = :address,  contact= :contact, start_date =:start_date, end_date =:end_date, budget =:budget, work =:work WHERE ads_id = :ads_id');
...
//////Delete ads ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     public function deletePost($ads_id){
        $this->db->query('DELETE FROM company_ads WHERE ads_id = :ads_id');
