...
<div class="modal-content" style="margin-top: -35%; margin-left:37%;  border-color:#0526BA">
        <form action= "<?php echo URLROOT; ?>/customers/update_ads/ <?php echo $data['post']->ads_id ?>" method="POST">
            ...
            <p class="heading" style="margin-top: 1em; margin-left:35%;">Update your Post <img src="<?php echo URLROOT;?>/public/img/ad.png" class="popup-image"></p>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <a class="pink-button" style="text-decoration:none; font-size:13px; margin-left:2em; margin-top:2.5em; padding: 9px 24px; display:inline;" href="<?php echo URLROOT; ?> /customers/customer_responses/"> Cancel </a>
                        </td>
                    </tr>
                </table>
                </br>
