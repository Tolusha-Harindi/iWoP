...
<table cellspacing="5" cellpadding="50" align="center">
        ...
        <tr>
            <td>
                <div>
                <img src="<?php echo URLROOT ?>/public/img/log.png" class="loginImage" alt="plant pot">   
                </div>
            </td>
            <!-- <td>
        ...
        <!-- <div class="loginverticalRuler"></div> -->
            ...
            <p class="register-link" style="margin-left: -1em; margin-top:2em;">Haven't Registered yet? Click here to <a href="<?php echo URLROOT; ?> /homes/register">Register</a> </p>
