...
<link rel='stylesheet' href="<?php echo URLROOT;?>/public/css/home/sidenav.css"/>
    ...
    <a href="<?php echo URLROOT;?>/admins/admin_profile" class='card-link'>
        ...
        <div class="sidebar">
            <div class="description">
            <a href="<?php echo URLROOT;?>admins/admin_dashboard" class='side-link-active'>
            ...
            <a href="<?php echo URLROOT;?>admin_faq" class='side-link'>
                    <ul class='side-list'>
                        <li>FAQ</li>
                    </ul>
            </a>
            <a href="<?php echo URLROOT;?>admin_registered_users" class='side-link'>
                    <ul class='side-list'>
