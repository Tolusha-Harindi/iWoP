    ...
    <div class="content">
        <div class="box1">
            <div class="container">
                ...
                <form name = "reg-w" onsubmit="return validation()" method="post" action="Reg-Com.php">
                    <div class="reg-start">
                            <div class="info">
                                    <div class="group">
                                    ...
                                    <div class="group">
                                        <input id="CRN" name=" CRN" type="int" placeholder = "Company Registered Number" class="input" required>
                                    </div>
                                    <div class="group">
