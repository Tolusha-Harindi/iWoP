...
<title> Responses by Workers </title>
...
<head> 
    ...
    <link rel="stylesheet" href="ResponsesbyWorkers.css">
        ...
        <div class= "box3"> 
            <div class="hor">
               ...
               <p class="txt5"> Accepted </p>
                <a href="../WorkerProfile-Userview/Worker-Profile-Userview.php" input type = "button"  value ="button" class="button2"> View Profile </a>
            </div>
            <div class="hor">
                </hr> 
                <img src="../../Images/img.png" alt="propic" class = "profpic">
