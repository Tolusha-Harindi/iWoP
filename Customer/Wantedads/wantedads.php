        ...
        <div id="NewAd" class="tabcontent">
                <div class="cardStyle">
                    <form action="wanted_ads.php" method="post" name="signupForm" id="signupForm">
                        ...
                        <div class="inputDiv">
                            <label class="inputLabel" for="category">Category <b class="red"> * </b></label>
                        ...
                        <div class="inputDiv">
                            <label class="inputLabel" for="title">Title <b class="red"> * </b></label>
                            <input type="text" name="title" id="title"  required>
                        </div>

                        <div class="inputDiv">
                            <label class="inputLabel" for="jobdescription">Job description <b class="red"> * </b></label>
                            <input type="text"name="job" id="jobdescription" required>
                        </div>

                        <div class="inputDiv">
                            <label class="inputLabel" for="city">Nearest City or Town <b class="red"> * </b></label>
                            <input type="text" name="nearest_city" id="city" required>
                        </div>

                        <div class="inputDiv">
                            <label class="inputLabel" for="phonenum">Phone Number <b class="red"> * </b></label>
                            <input type="tel" name="contact" id="phonenum" required>
                        </div>
                        <div class="inputDiv">
                            <label class="inputLabel" for="jobdescription">Starting Date <b class="red"> * </b></label>
                            <input type="date" name="startDate" id="start_date">
                        </div>

                        <div class="inputDiv">
                            <label class="inputLabel" for="duedate">Due Date <b class="red"> * </b></label>
                            <input type="date"name="dueDate" id="duedate">
                        </div>

                        <div class="inputDiv">
                            <label class="inputLabel" for="numofworkers">Number of Workers <b class="red"> * </b></label>
                            <input type="number" name="noOfWorkers" id="no_of_workers" >
                        </div>

                        <div class="inputDiv">
                            <label class="inputLabel" for="budget">Budget <b class="red"> * </b></label>
