    ...
    <div class="down-row" style="margin-top: 0; padding-top: 0">
        ...
        <div class="col-right-70" style="margin: 2px;">
            ...
            <div class="down-row" style="width: 100%;">
                <div class="col">
                    <center>
                        <div style="border: 1px solid hotpink; padding: 10px; margin: 10px; background: hotpink; width: 250px; height: 80px; text-align: center;">
            ...
            "></polyline>
                ...
                <div class="col">
                    <center>
                        <div style="border: 1px solid limegreen; padding: 10px; margin: 10px; background: limegreen; width: 250px; height: 80px; text-align: center;">
