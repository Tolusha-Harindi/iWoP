...
<head>
    ...
    <link rel="stylesheet" href="customer profile-worker view.css">
...
<div class="flex-container">
    ...
    <div class="mainbox">
       <input type="image" id="image" src="../images/profile.jpg">
    </div>
    ...
    <div class="sms">
       <a href="../chat/chat.php"><img src="../images/sms.jpg"></a>
    </div>
</div>
