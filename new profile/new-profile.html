       ...
       <div class="main-container">
          ...
          <div class="mainbox-side">
            <form action="new profile.php">
              ...
              <br/><br/><br/><br/>
              <label for="num1">Contact No 1 <span style="color:red">*</span></label>
              <input type="text" id="num1" name="num1" required>
              <br/><br/><br/><br/>
              <label for="num2">Contact No 2</label>
              <input type="text" id="num2" name="num2" required>
              <br/><br/><br/><br/>
              <label for="nic">NIC No <span style="color:red">*</span></label>
              <input type="text" id="nic" name="nic" required>
              <br/><br/><br/><br/>
              <label for="copy">Scan Copy of NIC <span style="color:red">*</span></label></br>
              <div class="one">
              ...
              <br/><br/><br/><br/>
               <button class="btn1" onclick="../bank-detail/bank-detail.php">Next</button>
            </form>
          </div>
       </div>
    </div>
