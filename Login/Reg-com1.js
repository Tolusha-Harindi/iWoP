...
function validation(){
  ...
  for (let i = 0; i < inputs.length; i++) {
    if (inputs[i].value == "") {
        console.log(1);
        inputs[i].style.border = "2px solid rgb(228, 29, 22)";
        inputs[i].style.backgroundColor = "rgb(0, 222, 215)";
  ...
  if (inputs[0].value!="" && inputs[0].value.match(nameType)==null) {
    console.log(2);
    inputs[0].value="";
    inputs[0].style.border = "2px solid rgb(228, 29, 22)";
  ...
  if (inputs[1].value!="" && inputs[1].value.match(contactType)==null) {
    console.log(3);
    inputs[1].value="";
    inputs[1].style.border = "2px solid rgb(228, 29, 22)";
  ...
  if (inputs[3].value!="" && inputs[3].value.match(emailType)==null) {
    console.log(4);
    inputs[3].value="";
    inputs[3].style.border = "2px solid rgb(228, 29, 22)";
  ...
  if (inputs[4].value!="" && inputs[4].value.match(passwordType)==null) {
    console.log(5);
    inputs[4].value="";
    inputs[4].style.border = "2px solid rgb(228, 29, 22)";
  ...
  if (inputs[4].value != inputs[5].value) {
    console.log(6);
    inputs[5].value="";
    inputs[5].style.border = "2px solid rgb(228, 29, 22)";
