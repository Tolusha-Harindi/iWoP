        ...
        <div class="col-right-70" style="margin: 2px;">
            <div class="down-row">
                <div class="col-left-30">
                    <label for="cPassword">Full Name <i class="red-s">*</i></label>
                    <label for="nPassword">Bank Name <i class="red-s">*</i></label>
                    <label for="ccPassword">Bank Branch <i class="red-s">*</i></label>
                    <label for="ccPassword">Bank Code <i class="red-s">*</i></label>
                    <label for="ccPassword">Account No <i class="red-s">*</i></label>
                </div>
                <div class="col-right-70" style="padding: 0;">
